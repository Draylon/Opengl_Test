...
public:
    ...
    void render2(){
        ...
        glRotatef(this->movement->Pitch,   -1, 0, 0);
        glRotatef(this->movement->Yaw, 0, -1, 0);
        glRotatef(this->movement->Roll,  0, 0, -1);
        GLUquadricObj* pObj;
        ...
        glRotatef(90, 1, 0, 0);
        gluCylinder(pObj, 0.2f, 0.2f, 5.0f, 26, 13);
        ...
        gluCylinder(pObj, 0.1f, 0.1f, 2.3f, 26, 13);
        glPopMatrix();
        ...
        glRotatef(90, 0.0f, 1.0f, 0.0f);
        glPushMatrix();
        glTranslatef(0.0f, 2.5f, 2.0f);
        glRotatef(angulo_bracos, 1, 0, 0);
        gluCylinder(pObj, 0.05f, 0.05f, 2.3f, 26, 13);
        glPopMatrix();
        glRotatef(180, 0.0f, 1.0f, 0.0f);
        glTranslatef(0.0f, 2.5f, 2.0f);
        glRotatef(angulo_bracos, 1, 0, 0);
        ...
        glRotatef(45, 1, 0, 0);
        gluCylinder(pObj, 0.1f, 0.1f, 3.5f, 26, 13);
        glPopMatrix();
        glRotatef(180, 0.0f, 1.0f, 0.0f);
        glTranslatef(0.0f, -1.0f, 0.0f);
        glRotatef(45, 1, 0, 0);
